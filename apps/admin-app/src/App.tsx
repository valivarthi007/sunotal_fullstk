    ...
    return (
      <Suspense fallback={<LoadingFallback />}>
        <Switch>
          ...
          <Route path="/dashboard" component={AdminRouteGuard} />
          <Route path="/admin/dashboard" component={AdminRouteGuard} />
          ...
          <Route path="/rider-payouts" component={RiderPayoutsAdmin} />
          <Route path="/admin/rider-payouts" component={RiderPayoutsAdmin} />
          <Route path="/riders" component={RiderPayoutsAdmin} />
