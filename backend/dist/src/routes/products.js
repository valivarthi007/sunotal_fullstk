...
import { ListProductsQueryParams, CreateProductBody, UpdateProductBody, GetProductParams, UpdateProductParams, DeleteProductParams, } from "../lib/schemas.js";
const router = Router();
...
router.post("/products", requireAdmin, async (req, res) => {
    ...
    const discountPercentage = data.originalPrice > 0
...
router.put("/products/:id", requireAdmin, async (req, res) => {
    ...
    const discountPercentage = data.originalPrice !== undefined && data.price !== undefined && data.originalPrice > 0
        ? Math.round(((data.originalPrice - data.price) / data.originalPrice) * 100)
        : undefined;
    const updateData = {
        ...data,
